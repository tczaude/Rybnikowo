...
SpawConfig::setStaticConfigItem('SPAW_DIR', '/_panel/spaw/');
...
// language 
SpawConfig::setStaticConfigItem('default_lang','pl');
...
SpawConfig::setStaticConfigItem(
  ...
  array(
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'/../../../images/flash/',
      'fsdir'   => SpawConfig::getStaticConfigValue('DOCUMENT_ROOT').'images/flash/', // optional absolute physical filesystem path
      'caption' => 'Flash', 
      'params'  => array(
        'allowed_filetypes' => array('flash', 'images')
      )
    ),
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'/../../../images/articles/',
      'fsdir'   => SpawConfig::getStaticConfigValue('DOCUMENT_ROOT').'images/articles/', // optional absolute physical filesystem path
      'caption' => 'Obrazki',
      'params'  => array(
    ...
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'/../../../images/files/',
      'fsdir'   => SpawConfig::getStaticConfigValue('DOCUMENT_ROOT').'images/files/', // optional absolute physical filesystem path
      'caption' => 'Pliki', 
      'params'  => array(
    ...
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'/../../../images/blog/',
      'fsdir'   => SpawConfig::getStaticConfigValue('DOCUMENT_ROOT').'images/blog/', // optional absolute physical filesystem path
      'caption' => 'Blog', 
      'params'  => array(
        'allowed_filetypes' => array('any')
      )
    ...
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'/../../../images/baners/',
      'fsdir'   => SpawConfig::getStaticConfigValue('DOCUMENT_ROOT').'images/baners/', // optional absolute physical filesystem path
      'caption' => 'Banery', 
      'params'  => array(
        'allowed_filetypes' => array('any')
      )
