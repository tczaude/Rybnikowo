<?php /* Smarty version 2.6.9, created on 2013-02-13 21:47:33
         compiled from baner_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'baner_list.tpl', 73, false),array('modifier', 'date_format', 'baner_list.tpl', 84, false),)), $this); ?>
                        ...
                        <div id="content">
                            ...
                            <div class="jquery_tab">
                                ...
                                <div class="content_block">
											...
											$("#order-list").sortable({
											    ...
											    update : function () {
													var order = $(\'#order-list\').sortable(\'serialize\');
											  			$("#info").load("/_panel/baner/sortable/?"+order);
											     	}
											});
									...
									<?php if ($this->_tpl_vars['baners_list']): ?>
									
									<?php $_from = $this->_tpl_vars['baners_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['baner'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['baner']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['baner']):
        $this->_foreach['baner']['iteration']++;
?>
									<?php echo smarty_function_cycle(array('name' => 'color','assign' => 'row_color','values' => "#EFEFEF ,#EFEFEF"), $this);?>

									
									
									  <li id="listItem_<?php echo $this->_tpl_vars['baner']['baner_id']; ?>
...
/images/arrow.png" alt="Przeciągnij aby zmienić kolejność" width="16" height="16" class="handle" />
											  <?php endif; ?>
											  <div class="name"><?php echo $this->_tpl_vars['baner']['title']; ?>
</div>
											  <div class="date"><?php echo ((is_array($_tmp=$this->_tpl_vars['baner']['date_created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
</div>
...
/baner/edit/<?php echo $this->_tpl_vars['baner']['baner_id']; ?>
...
/images/page_white_edit.png" border="0" title="<?php echo $this->_tpl_vars['dict_templates']['Edit']; ?>
 (<?php echo $this->_tpl_vars['language']['short']; ?>
												...
												<?php endforeach; endif; unset($_from); ?>
													...
													<?php if ($this->_tpl_vars['baner']['status'] == 2): ?>
														<a href="<?php echo $this->_tpl_vars['path']; ?>
/baner/status/<?php echo $this->_tpl_vars['baner']['baner_id']; ?>
...
"></a>
													<?php endif; ?>                                       
										            													<a href="<?php echo $this->_tpl_vars['path']; ?>
/baner/remove/<?php echo $this->_tpl_vars['baner']['baner_id']; ?>
"><img src="<?php echo $this->_tpl_vars['path']; ?>
