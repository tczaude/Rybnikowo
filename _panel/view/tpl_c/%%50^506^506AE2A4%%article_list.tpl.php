<?php /* Smarty version 2.6.9, created on 2013-02-22 21:59:36
         compiled from article_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'article_list.tpl', 87, false),array('modifier', 'date_format', 'article_list.tpl', 98, false),)), $this); ?>
                        ...
                        <div id="content">
                            ...
                            <div class="jquery_tab">
                                ...
                                <div class="content_block">
									...
									<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "article_paging.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
									...
									<?php if ($this->_tpl_vars['articles_list']): ?>
									
									<?php $_from = $this->_tpl_vars['articles_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['article'] = array('total' => count($_from), 'iteration' => 0);
...
/images/arrow.png" alt="Przeciągnij aby zmienić kolejność" width="16" height="16" class="handle" />
											  <?php endif; ?>
											  <div class="name"><?php echo $this->_tpl_vars['article']['title']; ?>
</div>
											  <div class="date"><?php echo ((is_array($_tmp=$this->_tpl_vars['article']['date_created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
</div>
...
/article/edit/<?php echo $this->_tpl_vars['article']['article_id']; ?>
...
/images/page_white_edit.png" border="0" title="<?php echo $this->_tpl_vars['dict_templates']['Edit']; ?>
 (<?php echo $this->_tpl_vars['language']['short']; ?>
												...
												<?php if ($this->_tpl_vars['article']['status'] == 2): ?>
													<a href="<?php echo $this->_tpl_vars['path']; ?>
/article/status/<?php echo $this->_tpl_vars['article']['article_id']; ?>
...
"></a>
												...
												<?php if ($this->_tpl_vars['CategoryId'] == 5): ?> 
													<?php if ($this->_tpl_vars['article']['sended'] == 1): ?>
													<img src="<?php echo $this->_tpl_vars['path']; ?>
/images/false_off.png" border="0" title="<?php echo $this->_tpl_vars['dict_templates']['Remove']; ?>
">
													<?php else: ?>                                      
													<a href="<?php echo $this->_tpl_vars['path']; ?>
/article/remove/<?php echo $this->_tpl_vars['article']['article_id']; ?>
"><img src="<?php echo $this->_tpl_vars['path']; ?>
