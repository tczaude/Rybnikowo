<?php /* Smarty version 2.6.9, created on 2013-03-29 14:33:01
         compiled from product_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'product_edit.tpl', 51, false),)), $this); ?>
                    ...
                    <div id="main">
                        ...
                        <div id="content">
							...
							<div class="content_block">
							    <h2 class="jquery_tab_title"><?php if (! $this->_tpl_vars['product']['id']): ?>Dodaj produkt<?php else: ?>Edycja produktu<?php endif; ?></h2>
							    ...
							    <form id="productForm" method="post" enctype="multipart/form-data">
									...
									<input type="hidden" name="product_form[product_id]" value="<?php echo $this->_tpl_vars['product']['product_id']; ?>
">
 ...
 - <?php echo $this->_tpl_vars['sub3']['name']; ?>
							        ...
							        <p>
							            ...
							            <select name="product_form[type]" id="product_form[type]" >
							            	<option value="">- wybierz -</option>
											<option value="1" <?php if ($this->_tpl_vars['product']['type'] == 1): ?>selected<?php endif; ?>>Nie</option>
											<option value="2" <?php if ($this->_tpl_vars['product']['type'] == 2): ?>selected<?php endif; ?>>Tak</option>
