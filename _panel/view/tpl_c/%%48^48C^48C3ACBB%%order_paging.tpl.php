<?php /* Smarty version 2.6.9, created on 2013-02-12 13:27:23
         compiled from order_paging.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'order_paging.tpl', 5, false),)), $this); ?>
	<div class="clearboth"></div>
				<div id="pagging">
					<?php if ($this->_tpl_vars['paging']['first']): ?><a href="<?php echo $this->_tpl_vars['path']; ?>
/order/index/<?php echo $this->_tpl_vars['paging']['first']; ?>
...
/order/index/<?php echo $this->_tpl_vars['paging']['previous']; ?>
"><?php endif; ?><img src="<?php echo $this->_tpl_vars['path']; ?>
...
/order/index/<?php echo $this->_tpl_vars['paging']['next']; ?>
"><?php endif; ?><img src="<?php echo $this->_tpl_vars['path']; ?>
...
/order/index/<?php echo $this->_tpl_vars['paging']['last']; ?>
"><?php endif; ?><img src="<?php echo $this->_tpl_vars['path']; ?>
