<?php /* Smarty version 2.6.9, created on 2013-03-08 14:32:31
         compiled from blog_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'blog_list.tpl', 77, false),array('modifier', 'date_format', 'blog_list.tpl', 86, false),)), $this); ?>
                        ...
                        <div id="content">
                            ...
                            <div class="jquery_tab">
                                ...
                                <div class="content_block">
									...
									<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "blog_paging.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
									...
									<?php if ($this->_tpl_vars['blogs_list']): ?>
									
									<?php $_from = $this->_tpl_vars['blogs_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['blog'] = array('total' => count($_from), 'iteration' => 0);
...
?>
									<?php echo smarty_function_cycle(array('name' => 'color','assign' => 'row_color','values' => "#EFEFEF ,#EFEFEF"), $this);?>
									  ...
									  <li id="listItem_<?php echo $this->_tpl_vars['blog']['blog_id']; ?>
" style="background-color: <?php echo $this->_tpl_vars['row_color']; ?>
">
											  
											<div style="float: left; width: 30px;"><?php if (! ($this->_foreach['blog']['iteration'] <= 1)): ?><a href="<?php echo $this->_tpl_vars['path']; ?>
/blog/up/<?php echo $this->_tpl_vars['blog']['blog_id']; ?>
/<?php echo $this->_tpl_vars['blog']['category_id']; ?>
"><img src="<?php echo $this->_tpl_vars['path']; ?>
/images/up.gif" border="0" title="<?php echo $this->_tpl_vars['dict_templates']['MoveUp']; ?>
"></a><?php endif; ?>&nbsp;</div>
											<div style="float: left; width: 30px;"><?php if (! ($this->_foreach['blog']['iteration'] == $this->_foreach['blog']['total'])): ?><a href="<?php echo $this->_tpl_vars['path']; ?>
/blog/down/<?php echo $this->_tpl_vars['blog']['blog_id']; ?>
/<?php echo $this->_tpl_vars['blog']['category_id']; ?>
"><img src="<?php echo $this->_tpl_vars['path']; ?>
/images/down.gif" border="0" title="<?php echo $this->_tpl_vars['dict_templates']['MoveDown']; ?>
"></a><?php endif; ?>&nbsp;</div>
							
											  <div class="name"><?php echo $this->_tpl_vars['blog']['title']; ?>
</div>
											  <div class="date"><?php echo ((is_array($_tmp=$this->_tpl_vars['blog']['date_created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
</div>
...
/blog/edit/<?php echo $this->_tpl_vars['blog']['blog_id']; ?>
...
/images/page_white_edit.png" border="0" title="<?php echo $this->_tpl_vars['dict_templates']['Edit']; ?>
 (<?php echo $this->_tpl_vars['language']['short']; ?>
												...
												<?php endforeach; endif; unset($_from); ?>
													...
													<?php if ($this->_tpl_vars['blog']['status'] == 2): ?>
														<a href="<?php echo $this->_tpl_vars['path']; ?>
/blog/status/<?php echo $this->_tpl_vars['blog']['blog_id']; ?>
...
"></a>
													<?php endif; ?>                                       
										            													<a href="<?php echo $this->_tpl_vars['path']; ?>
/blog/remove/<?php echo $this->_tpl_vars['blog']['blog_id']; ?>
"><img src="<?php echo $this->_tpl_vars['path']; ?>
