...
<h2>Załóż konto aby kontynuować zakupy</h2>
...
<div class="choose">
	...
	<div class="contentLeft">
		<div class="register">
					...
					<input type="hidden" value="RegisterUserForOrder" name="action" />
					<h4>Dane klienta</h4>
					...
					<p>
							...
							<span>{$BasketEmail}</span>
							<input type="hidden" name="register_form[email]" value="{$BasketEmail}">
